...
const MENSAJE = "Hola, quiero saber más sobre Angie para vender por WhatsApp";
...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-0 rounded-full bg-[#25D366] p-3 text-sm font-semibold text-white shadow-lg shadow-black/20 transition hover:brightness-105 sm:gap-2 sm:px-5"
    >
